...
const WiggleSeparator: React.FC = (): React.ReactElement => {
  return (
    <div className="wiggle-separator">
      <Wiggle />
    </div>
  );
};
      ...
      <div className="page-info">
        ...
        <div className="page__list text-center">
          ...
          <div className="mb-4 text--lg">
            Yes, in order to have the music synced, the tab to the link should be open. A Chrome extension is possible in the future. <span role="img">😎</span>{" "}
          </div>
          <div className="font-weight-bold text--lg">Can I request feaures/make a comment?</div>
          <div className="text--lg">
            Of course! It would be also much appreciated. You can do this{" "}
            <a className="link" href="https://forms.gle/LYAqcmCUKxigzUhg7">
              here
            </a>
            .
          </div>
...
const HomePageUnauthed = (): React.ReactElement => {
  return (
    <div className="page page--full">
      <div>
        <h1 className="text--xl font-weight-bold mb-3">
          Spotify Music Party <span role="img">🎉</span>
        </h1>
        <h2 className="text--lg mb-4">Listen to music in-sync with your friends</h2>
        <a href={APP_API.LOGIN} className="btn btn--primary">
          Login with Spotify
        </a>
      </div>
    </div>
...
const HomePageAuthed: React.FC<{ user: User }> = ({ user }): React.ReactElement => {
  ...
  const { logout, error: loginError } = useUser();
    ...
    <>
      <div className="page page--full">
        <div className="text-center">
          ...
          {loginError ? <div>You are already connected. Please check another open Spotify Music Party tab.</div> : <Button classes="btn--primary d-block mb-4" name="Start a party 🎉" onClick={createRoom}></Button>}
        </div>
  ...
  return (
    <div className="home">
      ...
      <div className="home__footer">
        <a href="https://maxs.space" onClick={logout} className="link">
          made by max
        </a>
      </div>
    </div>
