        ...
        <div className="page">
            <div className="page-info">
                ...
                <div className="page__list text-center">
                    <div className="font-weight-bold text--lg">Can I switch to be the host?</div>
                    <div className="mb-4 text--lg">Yes, the current host can make any other user the host.</div>
        ...
        <div className="page">
            <div className="page-info">
                ...
                <ol className="page__list">
                    ...
                    <li className="page__list-item text--lg">Each person gets synched up to the host's (DJ's) currently playing track</li>
                </ol>
...
const HomePageUnauthed = (): React.ReactElement => {
    return (
        <div className="page page--full">
            <div>
                <h1 className="text--xl font-weight-bold mb-3">Welcome to Listening Party  🎉</h1>
                <h2 className="text--lg mb-4">Listen to Spotify in-sync with your friends</h2>
                <a href={APP_API.LOGIN} className="btn btn--primary">Login with Spotify</a>
            </div>
        </div>);
}
        ...
        <>
            <div className="page page--full">
                <div className="text-center">
                    ...
                    <Button classes="btn--primary d-block" name="Start a party 🎉" onClick={createRoom}></Button>
                </div>
            </div>
        </>
    );
